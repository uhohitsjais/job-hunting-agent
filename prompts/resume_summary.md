...
Write a summary that positions Jais credibly for this specific role, emphasizing the strongest genuine overlaps between his background and the job. If the role is a stretch, lean on transferable experience rather than exaggerating direct experience. Never state a qualification, metric, or title that isn't backed by the candidate context or evidence library.
